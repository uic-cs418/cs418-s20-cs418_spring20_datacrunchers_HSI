# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 18:40:15 2020
...
"""
#lalalal=PSU_Demo_VPEH_SMOH_RFAC_MOBAD_df.corr()
#lalal=pd.DataFrame(lalalal)
#lalal[lalal['Obesity%']]

print("1.Higher cases of depression in a county are correlated with higher drug usage")
print("2.Counties with more uninsured people, have higher death rates")
print("3.Higher Coronary Heart Disease Cases in a county seen in counties with more obesity levels")
...
ax1 = fig.add_subplot(gs[0, 0])
ax1=sns.scatterplot(x='Major_Depression', y='Recent_Drug_Use', data=PSU_Demo_VPEH_df)
ax1.set_yscale('log')
ax1.set_xscale('log')
ax1.set_title("Depression, Drug Usage Positively Correlated (LogScaled)", fontsize=12)
plt.text(500,50, r'Correlation of 0.979')

#ax1.text(0,0, 'Drug Use is highly correlated with depression', style='italic')

ax2 = fig.add_subplot(gs[0, 1])
ax2=sns.scatterplot('Total_Deaths', 'Uninsured', data=PSU_Demo_VPEH_SMOH_RFAC_MOBAD_df)
ax2.set_xscale('log')
ax2.set_yscale('log')
ax2.set_title("Total Deaths and UnInsured People Positively Correlated(Log Scaled)", fontsize=12)
plt.text(500,50, r'Correlation of 0.9190')

ax3 = fig.add_subplot(gs[0, 2])
ax3=sns.scatterplot('Obesity', 'CHD', data=PSU_Demo_VPEH_SMOH_RFAC_MOBAD_df)
ax3.set_title("Obesity and Coronary Heart Disease Cases Positively Correlated", fontsize=12)
plt.text(20,50, r'Correlation of 0.0.75')
