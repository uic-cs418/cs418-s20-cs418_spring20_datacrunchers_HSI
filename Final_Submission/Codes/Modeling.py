# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 19:11:23 2020
...
def machinelearning(X,y):
    ...
    print('Baseline : Test Root Mean Squared Error:', np.sqrt(metrics.mean_squared_error(y_valid, BaselinePred)))
...
def modelrun(colname,mlmodel,X1):
    ...
    result,top5=machinelearning(X,np.array(y))
