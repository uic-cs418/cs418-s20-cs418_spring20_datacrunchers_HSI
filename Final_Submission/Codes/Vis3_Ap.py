# -*- coding: utf-8 -*-
"""
Created on Mon Apr 27 16:53:57 2020
...
ax1 = sns.barplot(x=corrs_depression.index,y=corrs_depression['Corr_Coef'],palette='icefire')
plt.xticks(rotation=90, fontsize=23)
plt.xlabel('States')
plt.ylabel('Correlation Value')
plt.title('Corr of Major Depression v/s Suicide', fontsize=20)

ax2 = fig.add_subplot(gs[0, 1])
ax2 = sns.barplot(x=corrs_Bf.index,y=corrs_Bf['Corr_Coef'],palette='icefire')
plt.xticks(rotation=90, fontsize=23)
plt.xlabel('States')
plt.ylabel('Correlation Value')
plt.title('Corr of Birth Defects v/s Premature Deliveries',fontsize=20)
...
plt.xlabel('States')
plt.ylabel('Correlation Value')
plt.title('Corr of Birth to women over 40 v/s Breast Cancer',fontsize=20)

ax4 = fig.add_subplot(gs[1, 1])
ax4 = sns.barplot(x=corrs_infant.index,y=corrs_infant['Corr_Coef'],palette='icefire')
plt.xticks(rotation=90, fontsize=23)
plt.ylabel('Correlation Value')
plt.title('Corr of Infant mortality v/s Birth defects',fontsize=20)
plt.xlabel('States')
...
plt.text(-60,-1.5,
"""
Major Depression & Suicide found to be positively correlated in almost all states.\n Same for Birth Defects & Premature Delivery, Births to women over 40 & Birth Cancer, Infant Mortality & Birth Defects""",fontsize=30)