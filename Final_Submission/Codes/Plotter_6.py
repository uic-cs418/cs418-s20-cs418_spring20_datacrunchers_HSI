...
plt.rcParams["figure.figsize"] = (5,5)
ax = sns.heatmap(Race_AgeCorr.transpose(), annot=True )
...
plt.text(0,5.5, 'Higher Population of Blacks, Asians & Hispanics are found in counties which have younger population, \nOpposite for Whites is true', fontsize=15)
plt.show() # ta-da!