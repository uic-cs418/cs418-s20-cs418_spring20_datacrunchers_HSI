...
print("2.Counties with more insured people, have higher death rates")
...
ax1.set_yscale('log')
ax1.set_xscale('log')
ax1.set_title("Depression Vs Drug Usage (Log Scaled)")
