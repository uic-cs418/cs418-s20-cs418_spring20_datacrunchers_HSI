...
print("4 . Counties with Higher Povery Level have more people who are less educated")
print("5 . Counties with Higher Povery Level have more death rates")
print("6 . Counties with Higher Povery Level have more lower average life expectancy levels")
...
ax1 = fig.add_subplot(gs[0, 0])
ax1=sns.scatterplot(x='No_HS_Diploma%', y='Poverty', data=Demo_VPEH_dfTemp)
plt.title('No High School Diploma Percentages & Poverty')
plt.text(.05,2, r'Correlation of 0.70')

ax2 = fig.add_subplot(gs[0, 1])
ax2=sns.scatterplot('All_Death', 'Poverty', data=PSU_Demo_VPEH_SMOH_df)
plt.title('Total Deaths & Poverty')
plt.text(800,3, r'Correlation of 0.60')

ax3 = fig.add_subplot(gs[0, 2])
ax3=sns.scatterplot('ALE', 'Poverty', data=PSU_Demo_VPEH_SMOH_df)
plt.title('Average Life Expectancy & Poverty')
plt.text(70,3, r'Correlation of -0.66')
